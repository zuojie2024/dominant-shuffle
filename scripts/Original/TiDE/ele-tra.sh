...
python -u run_longExp.py \
  ...
  --batch_size 24 \
  --learning_rate 0.001 \
  --itr 1 --train_epochs 3 >logs/original/$model_name'_electricity_'96.log
...
python -u run_longExp.py \
  ...
  --batch_size 24 \
  --learning_rate 0.001 \
  --itr 1 --train_epochs 3 >logs/original/$model_name'_electricity_'192.log
...
python -u run_longExp.py \
  ...
  --batch_size 24 \
  --learning_rate 0.001 \
  --itr 1 --train_epochs 3 >logs/original/$model_name'_electricity_'336.log
...
python -u run_longExp.py \
  ...
  --batch_size 24 \
  --learning_rate 0.001 \
  --itr 1 --train_epochs 3 >logs/original/$model_name'_electricity_'720.log
