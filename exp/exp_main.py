...
from models import Autoformer, LightTS, MICN , TiDE, iTransformer, SCINet
        ...
        for epoch in range(self.args.train_epochs):
            ...
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(train_loader):
                ...
                if self.args.in_batch_augmentation:
                    ...
                    methods = {'f_mask':aug.freq_mask, 'f_mix': aug.freq_mix, 'noise': aug.noise, 'warp': aug.warping, 'flip': aug.flipping, 'mask': aug.masking, 'mask_seg': aug.masking_seg, 'noise_input':aug.noise_input, 'dom_shuffle':aug.dom_shuffle}
